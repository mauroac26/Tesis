<div class="">
    ...
    <div class="collapse navbar-collapse font-weight-normal" id="cNavbar">
                ...
                <!-- <li class="nav-item"><a href="#modalPago" class="nav-link" data-toggle="modal" data-toggle="tooltip" data-placement="top" title="Pago"><img src="assets/add.png" width="25" height="25" class="d-inline-block align-center" alt=""></a></li> -->
                 
                        <li class="nav-item "><a class="nav-link " data-toggle="modal" data-toggle="tooltip" data-placement="top" title="Pago" href="#modalPago">Pago</a></li>

                        <li class="nav-item "><a class="nav-link" data-toggle="modal" data-toggle="tooltip" data-placement="top" title="Recibo" href="#modalRecibo">Recibo</a></li>
