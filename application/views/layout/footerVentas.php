<div class="">
                ...
                <!-- <div ><button class="btn btn-sm" id="btn_filtros"><i class="fa fa-filter"></i></button></div> -->
    ...
    <div class="collapse navbar-collapse font-weight-normal" id="cNavbar">
                ...
                <li class="nav-item"><a href="#modalVenta" class="nav-link" data-toggle="modal" data-toggle="tooltip" data-placement="top" title="Alta Venta"><i class="fa fa-plus fa-fw" aria-hidden="true"></i></a></li>
                 
                        <li class="nav-item "><a class="nav-link" data-toggle="modal" href="#AltaRemitoVenta">Remito</a></li>
                         
                        <!-- <div class="dropup">
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">Forma de Pago</a>
                            ...
                            <div class="dropdown-menu bg-light">
                                <h5 class="dropdown-header bg-dark">OPERACIONES</h5>
                                <a class="dropdown-item" id="" data-toggle="modal" href="#pendienteFacturarVenta">Remitos Pendientes de Facturar</a>
...
<script type="text/javascript" src="js/remitoVenta.js"></script>
